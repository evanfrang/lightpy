...
contains the necessary python libraries. I removed all jupyter
dependencies because it was very bloated so if you want to run in a
notebook install jupyter into your env.
